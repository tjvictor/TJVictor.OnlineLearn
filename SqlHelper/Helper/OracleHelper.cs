...
namespace TJVictor.DataBase.SqlHelper.Oracle
{
    public class OracleHelper : ISQLHelper, IDisposable
    {
        #region Property
        private OracleConnection globalConnection;
        ...
        #region Construction
        private OracleHelper(string connectionStr)
        {
            _connectionStr = connectionStr;
            globalConnection = new OracleConnection(_connectionStr);
        ...
        {
            return new OracleHelper(connectionStr) as ISQLHelper;
        }
            ...
            string[] parameters, object[] values, string[] outputParameters, object[] outValues)
        {
            ...
            OracleCommand sqlCommand = CreateSqlCommand(executeSql, commandType,
            ...
            string[] parameters, object[] values)
        {
            ...
            try
            {
                OracleDataAdapter adp = new OracleDataAdapter(sqlCommand);
                adp.Fill(result);
                if (transaction)
                    sqlCommand.Transaction.Commit();
                return result;
            ...
            string[] parameters, object[] values)
        {
            ...
            {
                if (transaction)
                    tran = sqlCommand.Connection.BeginTransaction(IsolationLevel.ReadCommitted);

                OracleDataAdapter adp = new OracleDataAdapter(sqlCommand);
                adp.Fill(result);

                if (transaction && sqlCommand.Transaction != null)
                    sqlCommand.Transaction.Commit();
                return result;
            }
            catch
            ...
            string[] parameters, object[] values, string[] outputParameters, object[] outputValues)
        {
            ...
            OracleCommand sqlCommand = new OracleCommand(executeSql, globalConnection);
            ...
            {
                if (transaction)
                    tran = globalConnection.BeginTransaction(IsolationLevel.ReadCommitted);
        ...
        private void FillParameters(OracleCommand command, string[] parameters, object[] values,
            string[] outputParameters, object[] outputValues)
        {
            ...
            if (outputParameters != null && outputParameters.Length != 0)
            {
                for (int i = 0; i < outputParameters.Length; i++)
                {
                    ...
                    if (value is string)
                    {
                        command.Parameters.Add(parameter, OracleDbType.NVarchar2, 4000);
        ...
        private void FillOutputValues(OracleCommand cmd, string[] outputParameters, object[] outputValues)
        {
        ...
        private OracleCommand CreateSqlCommand(string executeSql, CommandType commandType,
            string[] parameters, object[] values)
        {
            return CreateSqlCommand(executeSql, commandType, parameters, values, null, null);
        }

        private OracleCommand CreateSqlCommand(string executeSql, CommandType commandType,
            string[] parameters, object[] values, string[] outputParameters, object[] outputValues)
        {
            OracleConnection sqlConnection = new OracleConnection(_connectionStr);
            OracleCommand sqlCommand = null;
            try
            {
                sqlConnection.Open();
                sqlCommand = new OracleCommand(executeSql, sqlConnection);
                sqlCommand.CommandType = commandType;
                sqlCommand.CommandTimeout = commandTimeout;
                sqlCommand.BindByName = true;
