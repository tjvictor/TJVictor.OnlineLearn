...
namespace TJVictor.DataBase.SqlHelper.Access
{
    public class AccessHelper : ISQLHelper, IDisposable
    {
        #region Property
        private OleDbConnection globalConnection;
        private readonly int commandTimeout = 120;
        private readonly string _connectionStr;
        #endregion

        #region Construction
        private AccessHelper(string connectionStr)
        {
            _connectionStr = connectionStr;
            globalConnection = new OleDbConnection(_connectionStr);
        }
        ...
        {
            return new AccessHelper(connectionStr) as ISQLHelper;
        }
        ...
        public void CopyFromDR(IDataReader reader, object ob, string[] columns)
        {
        ...
        public int SpExecuteNonQueryWithOutput(string spName, bool transaction, string[] parameters, object[] values, string[] outputParameters, object[] outValues)
        {
        ...
        public int ExecuteNonQuery(string executeSql, bool transaction,
            CommandType commandType, string[] parameters, object[] values,
            string[] outputParameters, object[] outValues)
        {
            int result = -1;

            OleDbCommand oleDbCommand = CreateSqlCommand(executeSql, transaction, commandType,
                parameters, values);
            ...
            string[] parameters, object[] values)
        {
            ...
            OleDbCommand oleDbCommand = CreateSqlCommand(executeSql, false, commandType,
                parameters, values);
            try
            {
            ...
            string[] parameters, object[] values)
        {
            ...
            try
            {
                ...
                result = (T)oleDbCommand.ExecuteScalar();
                if (transaction)
                    oleDbCommand.Transaction.Commit();
                return result;
            }
            ...
            string[] parameters, object[] values)
        {
            ...
            try
            {
                OleDbDataAdapter adp = new OleDbDataAdapter(oleDbCommand);
                adp.Fill(result);
                if (transaction)
                    oleDbCommand.Transaction.Commit();
                return result;
            ...
            string[] parameters, object[] values, string[] outputParameters, object[] outputValues)
        {
            ...
            OleDbCommand oleDbCommand = new OleDbCommand(executeSql, globalConnection);
            oleDbCommand.Connection = globalConnection;
            oleDbCommand.CommandText = executeSql;
            ...
            try
            {
                ...
                FillParameters(oleDbCommand, parameters, values, outputParameters, outputValues);
                result = oleDbCommand.ExecuteNonQuery();
                if (transaction)
                    oleDbCommand.Transaction.Commit();
                return result;
        ...
        private void FillParameters(OleDbCommand command, string[] parameters, object[] values,
            string[] outputParameters, object[] outputValues)
        {
            ...
            if (outputParameters != null && outputParameters.Length != 0)
            {
                for (int i = 0; i < outputParameters.Length; i++)
                {
                    ...
                    if (value is string)
                    {
                        command.Parameters.Add(parameter, OleDbType.VarWChar, 4000);
        ...
        private void FillOutputValues(OleDbCommand cmd, string[] outputParameters, object[] outputValues)
        {
        ...
        private OleDbCommand CreateSqlCommand(string executeSql, bool transaction, CommandType commandType,
            string[] parameters, object[] values)
        {
        ...
        private OleDbCommand CreateSqlCommand(string executeSql, bool transaction, CommandType commandType,
            string[] parameters, object[] values, string[] outputParameters, object[] outputValues)
        {
            OleDbConnection sqlConnection = new OleDbConnection(_connectionStr);
            OleDbCommand sqlCommand = null;
            try
            {
                sqlConnection.Open();
                sqlCommand = new OleDbCommand(executeSql, sqlConnection);
