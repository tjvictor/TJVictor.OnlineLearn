...
namespace TJVictor.DataBase.SqlHelper.SQLite
{
    public class SQLiteHelper : ISQLHelper, IDisposable
    {
        #region Property
        private SQLiteConnection globalConnection;
        private readonly int commandTimeout = 120;
        private readonly string _connectionStr;
        #endregion

        #region Construction
        private SQLiteHelper(string connectionStr)
        {
            _connectionStr = connectionStr;
            globalConnection = new SQLiteConnection(_connectionStr);
        }
        ...
        {
            return new SQLiteHelper(connectionStr) as ISQLHelper;
        }
            ...
            string[] parameters, object[] values, string[] outputParameters, object[] outValues)
        {
            ...
            SQLiteCommand sqlCommand = CreateSqlCommand(executeSql, transaction, commandType,
            ...
            string[] parameters, object[] values)
        {
            ...
            SQLiteCommand sqlCommand = CreateSqlCommand(executeSql, false, commandType,
                parameters, values);
            try
            {
            ...
            string[] parameters, object[] values)
        {
            ...
            try
            {
                SQLiteDataAdapter adp = new SQLiteDataAdapter(sqlCommand);
                adp.Fill(result);
                if (transaction)
                    sqlCommand.Transaction.Commit();
                return result;
        ...
        public System.Xml.XmlReader ExecuteXmlReader(string executeSql)
        {
            throw new NotImplementedException();
        }

        public System.Xml.XmlReader ExecuteXmlReader(string executeSql, string[] parameters, object[] values)
        {
            throw new NotImplementedException();
        }

        public System.Xml.XmlReader SpExecuteXmlReader(string spName)
        {
            throw new NotImplementedException();
        }

        public System.Xml.XmlReader SpExecuteXmlReader(string spName, string[] parameters, object[] values)
        {
            throw new NotImplementedException();
        }

        public System.Xml.XmlReader ExecuteXmlReader(string executeSql, CommandType commandType, string[] parameters, object[] values)
        {
            throw new NotImplementedException();
        }
        #endregion
            ...
            string[] parameters, object[] values, string[] outputParameters, object[] outputValues)
        {
            ...
            SQLiteCommand sqlCommand = new SQLiteCommand(executeSql, globalConnection);
        ...
        private void FillParameters(SQLiteCommand command, string[] parameters, object[] values,
            string[] outputParameters, object[] outputValues)
        {
            ...
            if (outputParameters != null && outputParameters.Length != 0)
            {
                for (int i = 0; i < outputParameters.Length; i++)
                {
                    ...
                    if (value is string)
                    {
                        command.Parameters.Add(parameter, DbType.String, 8000);
        ...
        private void FillOutputValues(SQLiteCommand cmd, string[] outputParameters, object[] outputValues)
        {
        ...
        private SQLiteCommand CreateSqlCommand(string executeSql, bool transaction, CommandType commandType,
            string[] parameters, object[] values)
        {
        ...
        private SQLiteCommand CreateSqlCommand(string executeSql, bool transaction, CommandType commandType,
            string[] parameters, object[] values, string[] outputParameters, object[] outputValues)
        {
            SQLiteConnection sqlConnection = new SQLiteConnection(_connectionStr);
            SQLiteCommand sqlCommand = null;
            try
            {
                sqlConnection.Open();
                sqlCommand = new SQLiteCommand(executeSql, sqlConnection);
                sqlCommand.CommandType = commandType;
                sqlCommand.CommandTimeout = commandTimeout;
                if (transaction)
                    sqlCommand.Transaction =
